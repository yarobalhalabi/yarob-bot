...
def go_back(call):
    ...
    if step == "choose_amount":
        ...
        price_label = "UC" if user_data[user_id]["game"] == "pubg" else "ðŸ’Ž"
...
def confirm_delivery(call):
    ...
    confirm_msg = f"ØªÙ… Ø´Ø­Ù† Ø­Ø³Ø§Ø¨Ùƒ Ø¨Ù€ {amount} {unit} Ø¹Ù„Ù‰ Ø§Ù„Ù€ ID Ø§Ù„ØªØ§Ù„ÙŠ: ðŸ“±{game_id} Ø¨Ù†Ø¬Ø§Ø­ âœ…Ø´ÙƒØ±Ø§ Ù„ØªØ¹Ø§Ù…Ù„Ùƒ Ù…Ø¹Ù†Ø§ðŸŒŸ"
